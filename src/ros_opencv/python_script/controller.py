...
def visualservo(upper_left_x, upper_left_y, lower_right_x, lower_right_y):
    ...
    desired_upper_left_x = 235.57201385498047
    desired_upper_left_y = 429.3349838256836
    desired_lower_right_x = 7.587432861328125
    desired_lower_right_y = 335.56036949157715  
    ...
    max_linear_velocity = 0.325
    max_angular_velocity = 0.175
    ...
    if(measured_upper_left_x < 240 and measured_upper_left_y < 435 and measured_lower_right_x < 12 and measured_lower_right_y < 340):
